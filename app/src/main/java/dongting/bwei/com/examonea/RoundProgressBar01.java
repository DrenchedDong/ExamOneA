...
public class RoundProgressBar01 extends View {
    ...
    public RoundProgressBar01(Context context, AttributeSet attrs, int defStyle) {    
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);    
        Log.i(TAG, "RoundProgressBar01--onDraw");
        ...
        Log.i(TAG, "onDraw:"+"centre:"+centre+"--radius:"+radius);  
